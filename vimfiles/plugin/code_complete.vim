...
" ...
"
let g:temp_region = g:rs."...".g:re
" ---------------------------------------------
" C templates
let g:template = {}
let g:template['c'] = {}
let g:template['c']['cc'] = "/*  */\<left>\<left>\<left>"
let g:template['c']['once'] = "#ifndef  \<c-r>=GetFileName()\<cr>\<CR>#define  \<c-r>=GetFileName()\<cr>".
            \repeat("\<cr>",5)."#endif  /* \<c-r>=GetFileName()\<cr> */".repeat("\<up>",3)
let g:template['c']['for'] = "for (".g:temp_region." ; ".g:temp_region." ; ".g:temp_region.")\<cr>{\<cr>".
            \g:temp_region."\<cr>}\<cr>"
let g:template['c']['main'] = "int main(int argc, char \*argv\[\])\<cr>{\<cr>".g:temp_region."\<cr>}"
let g:template['c']['switch'] = "switch (".g:temp_region.")\<cr>{\<cr>case ".g:temp_region." :\<cr>break;\<cr>case ".
            \g:temp_region." :\<cr>break;\<cr>default :\<cr>break;\<cr>}"
let g:template['c']['if'] = "if (".g:temp_region.")\<cr>{\<cr>".g:temp_region."\<cr>}"
let g:template['c']['while'] = "while (".g:temp_region.")\<cr>{\<cr>".g:temp_region."\<cr>}"
let g:template['c']['ife'] = "if (".g:temp_region.")\<cr>{\<cr>".g:temp_region."\<cr>} else\<cr>{\<cr>".g:rs."...".
            \g:re."\<cr>}"
...
" common templates
let g:template['_'] = {}
let g:template['_']['now'] = "\<c-r>=strftime(\"%Y-%m-%d %H:%M:%S\")\<cr>"
